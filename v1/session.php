        ...
        <div class="row">
            <div class="col-md-12">
                <div class="contact_form">
                    <div id="message"></div>
                    <form id="contactForm" action="session_action.php" name="sentMessage" novalidate="novalidate" method="post">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <input class="form-control" id="mdp2" name="mdp" type="tel" placeholder="mot de passe"  data-validation-required-message="Please enter your phone number.">
                                    <p class="help-block text-danger"></p>
                                </div>
                                <div class="form-group">
                                    <div id="success"></div>
                                    <button id="sendMessageButton" class="form-control" style="background-color: yellow;"data-text="Send Message" type="submit">Connexion</button>
                                </div>
                            </div>
