...
$mysqli = new mysqli('localhost','zsallso00','rp5cbz59','zfl2-zsallso00_1');
$sql = "SELECT Pad.*, Atelier.ad_intitule,Atelier.ate_date , Ressource.res_titre,Ressource.res_chemin_acces FROM Pad LEFT JOIN Atelier ON Pad.pad_id = Atelier.pad_id LEFT JOIN Ressource ON Atelier.ate_id = Ressource.ate_id WHERE Pad.pad_code =".$code_pad."";
...
if ($result1 == false ) { //Erreur lors de l’exécution de la requête
    ...
    exit();
       ...
       // Afficher les résultats dans un tableau HTMl
        echo"<table style='background_color: blue;
        border: 1px solid black;
        margin: auto;'><tr><th style='background_color: #ccc;
        border: 1px solid black;
        margin: auto;'>Atelier_intitule</th><th style='background_color: #ccc;
        border: 1px solid black;
        margin: auto;'>Ressource_intitule</th><th style='background_color: #ccc;
        border: 1px solid black;
        margin: auto;'>Lien</th></tr>";
        while ($row = $result1->fetch_assoc()) {
         
          echo ('<tr><td>'. $row['ad_intitule'] . ' <br></td><td>'. $row['res_titre'] . '<br></td>');
          echo ('<td><a href= '.$row['res_chemin_acces'].'>lien'.'</a>' . '<br></td></tr>');
          echo "<br />";
