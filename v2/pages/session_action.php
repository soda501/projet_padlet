...
$sql="SELECT * FROM Compte JOIN Profil USING(cpt_pseudo) WHERE
cpt_pseudo='" . $id . "' AND cpt_mot_passe=MD5('" . $motdepasse . "') AND validite='A';";
//echo($sql);
...
exit();
         ...
         if($resultat->num_rows == 1 && $ligne["validite"]=='A')
                 {echo"profil valide";}
